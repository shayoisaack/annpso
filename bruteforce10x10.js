...
let resObj = fs.readFileSync('reservoirs/small 1.json', 'utf8');
            ...
            for(let j2 = 0; j2 < resObj.cols; j2++){
                for(let i3 = 0; i3 < resObj.rows; i3++){
                    for(let j3 = 0; j3 < resObj.cols; j3++){
                        if((i1 === i2 && j1 === j2) || (i1 === i3 && j1 === j3) || (i2 === i3 && j2 === j3) || (i1 === i2 === i3 && j1 === j2 === j3)) continue;

                        console.log('testing: ('+i1+','+j1+'), ('+i2+','+j2+'), ('+i3+','+j3+')' );
